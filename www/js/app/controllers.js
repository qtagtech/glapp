...
angular.module('starter.controllers', ['nui.ionic', 'nui.ionic.box2d','timer','ionMdInput'])
  ...
  .controller('AppCtrl', function($scope,$state, $ionicModal, $ionicPopover, $timeout, ionicMaterialInk, ionicMaterialMotion, $ionicLoading,UserService) {
  ...
  .controller('CategoriesCtrl',['$scope','$sce', '$stateParams', '$timeout', 'ionicMaterialInk', 'ionicMaterialMotion',function($scope,$sce, $stateParams, $timeout,ionicMaterialInk, ionicMaterialMotion) {
    $scope.$parent.showHeader();
    $scope.$parent.clearFabs();
    $scope.isExpanded = true;
    $scope.$parent.setExpanded(true);
    ...
    $scope.categories = [
      {
        ...
        image:{
          url: "http://www.lorempixel.com/1080/1080/people"
        }
      },
      {
        name: "Cara",
        description: "Productos para el cuidado del cabello",
        image:{
          url: "http://www.lorempixel.com/1080/1080/nightlife"
        }
      },
      {
        name: "Piel",
        description: "Productos para el cuidado del cabello",
        image:{
          url: "http://www.lorempixel.com/1080/1080/nature"
        }
      },
      {
        name: "Spa",
        description: "Productos para el cuidado del cabello",
        image:{
          url: "http://www.lorempixel.com/1080/1080/fashion"
        }
      },
      {
        name: "Accesorios",
        description: "Productos para el cuidado del cabello",
        image:{
          url: "http://www.lorempixel.com/1080/1080/technics"
        }
      },
      {
        name: "Labios",
        description: "Productos para el cuidado del cabello",
        image:{
          url: "http://www.lorempixel.com/1080/1080/abstract"
        }
      },
    ];
